...
4. This will deploy `target/san-maven-362.ear` to the running instance of the server.


Access the application 
---------------------

The application will be running at the following URL: <http://localhost:8080/san-maven-362-web>.
...
You should see messages similar to the following:
    ...
    INFO  [net.w2ps.controller.MemberRegistration] (http--127.0.0.1-8080-2) Registering Jane Doe
    INFO  [net.w2ps.test.MemberRegistrationTest] (http--127.0.0.1-8080-2) Jane Doe was persisted with id 1
    ...
    INFO  [org.jboss.as.connector.subsystems.datasources] (MSC service thread 1-5) JBAS010409: Unbound data source [jboss/datasources/san-maven-362TestDS]
